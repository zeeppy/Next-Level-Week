...
// iniciando/criando o objeto que vai fazer operações no banco de dados

const db = new sqlite3.Database("./src/database/database.db")

module.exports = db

    // utilizando o objeto de db para nossas operações 
    //db.serialize(() => {
        ...
        // 3- consultar dados
        // 4- deletar um dado
        // o ultimo item da tabela nao recebe virgula
    // db.run(`
